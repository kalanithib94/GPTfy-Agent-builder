...
function buildHandlerApex(handlerClass: string, logPrefix: string): string {
  return `/**
 * Generated by GPTfy Agent Generator (template). Replace stub logic with your use case.
 * Implements AIAgenticInterface — skill name must match AI Prompt Name exactly.
 */
public with sharing class ${handlerClass} implements AIAgenticInterface {
...
export function buildTemplateBundle(
  ...
  const handlerApex = buildHandlerApex(params.handlerClass, logPrefix);
